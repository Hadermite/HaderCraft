...
package se.wiklund.minecraft2d.util.blur;
...
public class GaussianFilter extends ConvolveFilter {
	...
	public void setRadius(float radius) {
		...
		System.out.println("It took " + (System.currentTimeMillis() - startTime) + " milliseconds to make the kernel");
	}
	...
	public BufferedImage filter(BufferedImage src, BufferedImage dst) {
		...
		if (dst == null) {
			...
			System.out.println(
					"It took " + (System.currentTimeMillis() - startTime) + " milliseconds to create the image");
		}
		...
		System.out.println("It took " + (System.currentTimeMillis() - startTime) + " milliseconds to get image data");

		startTime = System.currentTimeMillis();
		convolveAndTranspose(kernel, inPixels, outPixels, width, height, alpha, CLAMP_EDGES);
		System.out
				.println("It took " + (System.currentTimeMillis() - startTime) + " milliseconds to make process first");
		startTime = System.currentTimeMillis();
		convolveAndTranspose(kernel, outPixels, inPixels, height, width, alpha, CLAMP_EDGES);
		System.out.println(
				"It took " + (System.currentTimeMillis() - startTime) + " milliseconds to make process second");
		startTime = System.currentTimeMillis();
		dst.setRGB(0, 0, width, height, inPixels, 0, width);
		System.out.println(
				"It took " + (System.currentTimeMillis() - startTime) + " milliseconds to set image data");
		return dst;
	}
